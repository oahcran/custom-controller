...
import (
	...
	scheme "github.com/oahcran/custom-controller/pkg/generated/clientset/versioned/scheme"
...
type FooInterface interface {
	Create(*v1alpha2.Foo) (*v1alpha2.Foo, error)
	Update(*v1alpha2.Foo) (*v1alpha2.Foo, error)
	UpdateStatus(*v1alpha2.Foo) (*v1alpha2.Foo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Foo, error)
	List(opts v1.ListOptions) (*v1alpha2.FooList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Foo, err error)
	FooExpansion
}
...
func newFoos(c *CustomcontrollerV1alpha2Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(name string, options v1.GetOptions) (result *v1alpha2.Foo, err error) {
	result = &v1alpha2.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts v1.ListOptions) (result *v1alpha2.FooList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.FooList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Create(foo *v1alpha2.Foo) (result *v1alpha2.Foo, err error) {
	result = &v1alpha2.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *v1alpha2.Foo) (result *v1alpha2.Foo, err error) {
	result = &v1alpha2.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) UpdateStatus(foo *v1alpha2.Foo) (result *v1alpha2.Foo, err error) {
	result = &v1alpha2.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Foo, err error) {
	result = &v1alpha2.Foo{}
