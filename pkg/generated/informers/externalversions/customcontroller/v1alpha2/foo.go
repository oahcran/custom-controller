...
import (
	...
	customcontrollerv1alpha2 "github.com/oahcran/custom-controller/pkg/apis/customcontroller/v1alpha2"
	versioned "github.com/oahcran/custom-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/oahcran/custom-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha2 "github.com/oahcran/custom-controller/pkg/generated/listers/customcontroller/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomcontrollerV1alpha2().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomcontrollerV1alpha2().Foos(namespace).Watch(options)
			},
		},
		&customcontrollerv1alpha2.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customcontrollerv1alpha2.Foo{}, f.defaultInformer)
}
